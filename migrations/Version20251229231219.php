 ...
 */
final class Version20251229231219 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE equipo_fantasy (id INT AUTO_INCREMENT NOT NULL, presupuesto DOUBLE PRECISION NOT NULL, datos_alineacion JSON NOT NULL, puntos INT NOT NULL, ligafantasy_id INT NOT NULL, entrenador_id INT DEFAULT NULL, INDEX IDX_5D0D50218B2F69BF (ligafantasy_id), INDEX IDX_5D0D50214FE90CDB (entrenador_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        ...
        $this->addSql('CREATE TABLE jugadores (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, estadisticas INT NOT NULL, valordemercado INT NOT NULL, equipo_id INT DEFAULT NULL, INDEX IDX_CF491B7623BFBED (equipo_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE liga_fantasy (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, minimo_jugadores INT NOT NULL, puntuaje INT NOT NULL, cierredemercado INT DEFAULT NULL, torneo_id INT DEFAULT NULL, administrador_id INT DEFAULT NULL, INDEX IDX_47E3DA2A0139802 (torneo_id), INDEX IDX_47E3DA248DFEBB7 (administrador_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        ...
        $this->addSql('ALTER TABLE equipo_fantasy ADD CONSTRAINT FK_5D0D50218B2F69BF FOREIGN KEY (ligafantasy_id) REFERENCES liga_fantasy (id) ON DELETE CASCADE');
