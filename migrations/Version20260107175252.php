 ...
 */
final class Version20260107175252 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE jugadores CHANGE valordemercado valor_de_mercado INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE jugadores CHANGE valor_de_mercado valordemercado INT NOT NULL');
